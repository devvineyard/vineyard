...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: LetsTalkWidget.routeName,
          path: LetsTalkWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'LetsTalk')
              : LetsTalkWidget(),
        ),
        FFRoute(
          name: VimsWidget.routeName,
          path: VimsWidget.routePath,
          builder: (context, params) =>
              params.isEmpty ? NavBarPage(initialPage: 'VIMS') : VimsWidget(),
        ),
        FFRoute(
          name: UploadServiceWidget.routeName,
          path: UploadServiceWidget.routePath,
          builder: (context, params) => UploadServiceWidget(),
        ),
        FFRoute(
          name: UploadEventWidget.routeName,
          path: UploadEventWidget.routePath,
          builder: (context, params) => UploadEventWidget(),
        ),
        FFRoute(
          name: UploadBibleVerseWidget.routeName,
          path: UploadBibleVerseWidget.routePath,
          builder: (context, params) => UploadBibleVerseWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: CheckoutLastPageWidget.routeName,
          path: CheckoutLastPageWidget.routePath,
          builder: (context, params) => CheckoutLastPageWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: BooksPurchasedWidget.routeName,
          path: BooksPurchasedWidget.routePath,
          builder: (context, params) => BooksPurchasedWidget(),
        ),
        FFRoute(
          name: ViewPurchaseWidget.routeName,
          path: ViewPurchaseWidget.routePath,
          asyncParams: {
            'cartItem': getDoc(['cart'], CartRecord.fromSnapshot),
          },
          builder: (context, params) => ViewPurchaseWidget(
            cartItem: params.getParam(
              'cartItem',
              ParamType.Document,
            ),
          ),
        ...
        FFRoute(
          name: DonationConfirmationWidget.routeName,
          path: DonationConfirmationWidget.routePath,
          builder: (context, params) => DonationConfirmationWidget(
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/WhatsApp_Image_2025-07-03_at_21.04.08.jpeg',
                    fit: BoxFit.cover,
                  ),
                )
              : page;
