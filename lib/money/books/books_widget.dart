                        ...
                        if (valueOrDefault<bool>(
                          ...
                          AuthUserStreamWidget(
                            builder: (context) => InkWell(
                              ...
                              onTap: () async {
                                context
                                    .pushNamed(BooksPurchasedWidget.routeName);
                              },
                              child: Material(
                                color: Colors.transparent,
                                child: ListTile(
                        ...
                        children: [
                          Padding(
                            ...
                            child: InkWell(
                              ...
                              highlightColor: Colors.transparent,
                              onTap: () async {
                                if ((currentUserDocument?.cartBooksRef
                                                ?.toList() ??
                                            [])
                                        .contains('R200') ==
                                    true) {
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
                                        'Recognition Already Exists in Cart',
                                        style: TextStyle(
                                          color: FlutterFlowTheme.of(context)
                                              .primaryText,
                                        ),
                                  ...
                                  FFAppState().cartTotal =
                                      functions.incrementCartTotalValue(
                                          200.0, FFAppState().cartTotal);
                                  FFAppState().cartTotalQuantity =
                                      FFAppState().cartTotalQuantity + 1;
                                  safeSetState(() {});
                              ...
                              onTap: () async {
                                if ((currentUserDocument?.cartBooksRef
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
                                        'Developing The Kingdom Culture Already Exists in Cart',
                                        style: TextStyle(
                                          color: FlutterFlowTheme.of(context)
                                              .primaryText,
                                        ),
                                  ...
                                  await CartRecord.collection.doc().set({
                                    ...createCartRecordData(
                                      name: 'Developing The Kingdom Culture',
                                      price: 200.0,
                                      quantity: 1,
                                      id: 'D200',
                                      userRef: currentUserReference,
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Column(
                                            ...
                                            children: [
                                              Text(
                                                'Developing The Kingdom Culture',
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .bodyLarge
                                                        .override(
                              ...
                              onTap: () async {
                                if ((currentUserDocument?.cartBooksRef
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
                                        'I Press Already Exists in Cart',
                                        style: TextStyle(
                                          color: FlutterFlowTheme.of(context)
                                              .primaryText,
                                        ),
                              ...
                              onTap: () async {
                                if ((currentUserDocument?.cartBooksRef
                                  ...
                                  ScaffoldMessenger.of(context).showSnackBar(
                                    SnackBar(
                                      content: Text(
                                        'Victory In My Scars Already Exists in Cart',
                                        style: TextStyle(
                                          color: FlutterFlowTheme.of(context)
                                              .primaryText,
                                        ),
