...
import 'checkout_last_page_model.dart';
export 'checkout_last_page_model.dart';

class CheckoutLastPageWidget extends StatefulWidget {
  const CheckoutLastPageWidget({super.key});

  static String routeName = 'CheckoutLastPage';
  static String routePath = '/checkoutLastPage';

  @override
  State<CheckoutLastPageWidget> createState() => _CheckoutLastPageWidgetState();
}

class _CheckoutLastPageWidgetState extends State<CheckoutLastPageWidget> {
  late CheckoutLastPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CheckoutLastPageModel());
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'Please fill in the information below to continue. This information will be used to deliver the book to your nearest Pep store.',
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Flexible(
                                        child: Text(
                                          'I acknowledge that my purchase will be delivered to the nearest PEP store based on the details I have provided above. I understand that it is my responsibility to ensure that I collect and receive my package.',
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                                              .override(
                                                font: GoogleFonts.inter(
                                ...
                                : () async {
                                    ...
                                    if (_model.validationResult!) {
                                      ...
                                      triggerPushNotification(
                                        notificationTitle: 'Book Purchased!',
                                        notificationText:
                                            'A user has purchased a book. Please log in to ensure it\'s delivered in the appropriate time. ',
                                        notificationSound: 'default',
                                        userRefs: _model.usersList!
                                            .map((e) => e.reference)
                                            .toList(),
                                        initialPageName: 'BooksPurchased',
                                        parameterData: {},
                                      );
